class room6 extends Phaser.Scene {
  ...
  preload() {
    // Step 1, load JSON
    this.load.tilemapTiledJSON("room6", "assets/room2.tmj");
    ...
    this.load.image("keyz2", "assets/key.png");
  ...
  create() {
    ...
    //key//
    this.keyz2 = this.physics.add.sprite(315,500, "keyz2")
    ...
    this.physics.add.overlap(this.keyz2, this.player, this.collectkey, null, this);
  ...
  update() {
    if(this.player.x > 870 && this.player.x < 890 && this.player.y > 260 && this.player.y < 269 ) {
