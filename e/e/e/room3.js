class room3 extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image("keyz1", "assets/key.png");
    ...
    create() {
      ...
      //key//
      this.keyz1 = this.physics.add.sprite(524,300, "keyz1")
    ...
    image.setAlpha(0.6);
      ...
      this.physics.add.overlap(this.keyz1, this.player, this.collectkey, null, this);
